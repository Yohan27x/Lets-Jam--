...
var dialogue_text = [
	{"speaker" : "yohan", "text" : "test test sdf qsdf qsdfds ", "dialogue_speed" : 0.01, "delay_after_trigger" : 0.001, "ready" : false, "stay_on_screen" : 1, "go_to_next" : true },
	{"speaker" : "ana", "text" : "ouaf oauf oauf  ", "dialogue_speed" : 0.01, "delay_after_trigger" : 0.4, "ready" : false, "stay_on_screen" : 2, "go_to_next" : true },
